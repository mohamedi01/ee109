...
trait AccelWrapper extends Module {
  ...
  // Memory Streams
  val io_loadStreamInfo = List(StreamParInfo(32, 1, 0), StreamParInfo(32, 1, 0)) 
  ...
  // Root controller for app: PowerSpectrumTest
  
  // Widths: 1, 2, 2, 2, 2, 2, 2, 2, 3
  //   Widest Outer Controller: 3
  // Depths: 2, 4, 4, 4, 5, 5, 5, 5, 5, 5
  //   Deepest Inner Controller: 5
  // App Characteristics: HasTileLoad,HasUnalignedLoad,HasTileStore,HasUnalignedStore
  // Instrumentation
  val io_numArgOuts_instr = 56
  val io_numArgCtrls = 19
