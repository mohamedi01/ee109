...
trait AccelWrapper extends Module {
  ...
  // Memory Streams
  val io_loadStreamInfo = List(StreamParInfo(24, 1, 0), StreamParInfo(24, 1, 0)) 
  val io_storeStreamInfo = List(StreamParInfo(24, 1, 0)) 
  ...
  // Root controller for app: MelFilterbankTest
  
  // Widths: 1, 2, 2, 2, 2, 2, 2, 2, 2, 3
  //   Widest Outer Controller: 3
  // Depths: 3, 3, 4, 4, 4, 5, 5, 5, 5, 5, 5
  //   Deepest Inner Controller: 5
  // App Characteristics: HasTileLoad,HasUnalignedLoad,HasTileStore,HasUnalignedStore
  // Instrumentation
  val io_numArgOuts_instr = 60
  val io_numArgCtrls = 21
