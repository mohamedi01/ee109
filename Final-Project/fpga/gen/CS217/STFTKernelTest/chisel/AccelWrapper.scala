...
trait AccelWrapper extends Module {
  ...
  // Memory Streams
  val io_loadStreamInfo = List(StreamParInfo(32, 1, 0)) 
  val io_storeStreamInfo = List(StreamParInfo(32, 1, 0), StreamParInfo(32, 1, 0)) 
  ...
  // Root controller for app: STFTKernelTest
  
  // Widths: 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 3, 3
  //   Widest Outer Controller: 3
  // Depths: 3, 3, 3, 3, 4, 5, 5, 5, 5, 6, 6, 6, 6
  //   Deepest Inner Controller: 6
  // App Characteristics: HasTileLoad,HasUnalignedLoad,HasTileStore,HasUnalignedStore
  // Instrumentation
  val io_numArgOuts_instr = 68
  val io_numArgCtrls = 25
