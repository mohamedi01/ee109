...
trait AccelWrapper extends Module {
  ...
  // Root controller for app: LogCompressTest
  
  // Widths: 1, 2, 2, 2, 2, 2, 4
  //   Widest Outer Controller: 4
  // Depths: 2, 3, 3, 3, 4, 4, 4, 5, 5
  //   Deepest Inner Controller: 5
  // App Characteristics: HasTileLoad,HasUnalignedLoad,HasTileStore,HasUnalignedStore
  // Instrumentation
  val io_numArgOuts_instr = 44
  val io_numArgCtrls = 16
