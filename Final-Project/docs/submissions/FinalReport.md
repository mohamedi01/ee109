...
**GitHub Repository:**  
The code of the project can be found at the following [GitHub Repo](https://github.com/your-repo-link-here). The `README.md` and `docs/architecture.md` files describe how to set up the requirements, run the different parts of the code, and outline the high-level architecture.
