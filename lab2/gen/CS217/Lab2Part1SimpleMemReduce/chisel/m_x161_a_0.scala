...
class x161_a_0 {
  lazy val w0 = Access(185, 0, 0, List(0), List(0), None, PortInfo(Some(0), 1, 5, List(1), 32, List(List(RG(0)))))
  lazy val r0 = Access(179, 0, 0, List(0), List(0), None, PortInfo(Some(0), 1, 5, List(1), 32, List(List(RG(0)))))
  lazy val r1 = Access(200, 1, 0, List(0), List(0), None, PortInfo(Some(0), 1, 5, List(1), 32, List(List(RG(0)))))
