...
class x934_tileA_sram_0 {
  lazy val w0 = Access(998, 0, 0, List(0), List(0), None, PortInfo(Some(0), 1, 9, List(1), 32, List(List(RG(0)))))
  lazy val r0 = Access(1175, 0, 0, List(0), List(0), None, PortInfo(Some(1), 1, 9, List(1), 32, List(List(RG(0)))))
