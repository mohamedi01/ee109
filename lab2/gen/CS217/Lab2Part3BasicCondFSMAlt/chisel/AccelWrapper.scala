...
trait AccelWrapper extends Module {
  ...
  // Root controller for app: Lab2Part3BasicCondFSMAlt
  
  // Widths: 2, 3
  //   Widest Outer Controller: 3
  // Depths: 2, 3, 3, 3
  //   Deepest Inner Controller: 3
  // App Characteristics: HasFSM,HasTileStore,HasUnalignedStore
  // Instrumentation
  val io_numArgOuts_instr = 18
  val io_numArgCtrls = 6
