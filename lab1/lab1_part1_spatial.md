...
1. [Set up](#setup)
    * [Packages](#packages)
    * [SDKMAN!](#sdkman)
    * [Java, Scala, sbt](#java-scala-sbt)
    * [Spatial](#spatial)
2. [Manually Running Spatial Applications](#manually-running-spatial-applications)
3. [Using Registers](#using-registers)
4. [Using DRAM and SRAM](#using-dram-and-sram)
5. [Using FIFO](#using-fifo)
6. [Using Controllers](#using-controllers)
...
## Submission
* [Using Registers](#using-registers): Modify this app so that it fetches three numbers from the CPU side and calculates their sum. You can assume that your user only enters integers. Leave your implementation in `Lab1Part1RegExample3`.
* [Using DRAM and SRAM](#using-dram-and-sram): Fill in the fields in `Lab1Part2DramSramExample` according to the instructions in [this section](#your-turn-1).
* [Using FIFO](#using-fifo): Reimplement the example in Part 2 using FIFO. You can leave your implementation under Lab1Part4FIFOExample.
* [Using Controllers](#using-controllers): Use Fold controller to calculate the sum of an element. Leave your implementation in `Lab1Part6FoldExample`.
